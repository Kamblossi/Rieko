...
import { shouldUseRiekoCloudAPI } from "@/lib/functions/rieko-cloud.api";
  ...
  const vad = useMicVAD({
    ...
    onSpeechEnd: async (audio) => {
      try {
        ...
        if (!selectedSttProvider.provider && !useRiekoCloudAPI) {
        ...
        if (!providerConfig && !useRiekoCloudAPI) {
        ...
        transcription = await fetchSTT({
          provider: useRiekoCloudAPI ? undefined : providerConfig,
